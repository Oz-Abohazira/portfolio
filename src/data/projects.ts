...
`,
...

  {
    ...
    status: "completed",
    description:
      "Designed and implemented a centralized monitoring application that tracked every site and device, generated automated reports, and provided real-time system health statistics across the state.",
    technologies: [
      "Python",
      "System Monitoring",
      "Automated Reports",
...
export const commands = [
  ...
  {
    command: "--clear",
    description: "Clear terminal and reset to initial state",
  },
  {
    command: "reset-progress",
    description: "Reset puzzle and contact challenge progress",
  },
